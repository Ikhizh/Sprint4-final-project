...
public class ImportantQuestionsDropdownTest {
    ...
    public ImportantQuestionsDropdownTest(int arrowNumber, String question, String expectedText) {
    ...
    public void arrowCheck() {
        mainPageScooter.pressArrow(arrowNumber, question);
        mainPageScooter.checkArrowOpened(arrowNumber);
        mainPageScooter.checkArrowText(arrowNumber, expectedText);
    }
}
